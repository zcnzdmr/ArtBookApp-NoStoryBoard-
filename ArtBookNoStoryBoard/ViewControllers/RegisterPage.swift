...
//        imagem.layer.borderWidth = 0.4
        ...
        nameOfPainter.frame = CGRect(x: 10, y: 510, width: screenWidth-20, height: 30)
        nameOfPainter.placeholder = "Painter name"
        nameOfPainter.layer.borderWidth = 0.4
        view.addSubview(nameOfPainter)
        
        
        timeOfPainting.frame = CGRect(x: 10, y: 560, width: screenWidth-20, height: 30)
